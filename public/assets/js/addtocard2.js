document.addEventListener("DOMContentLoaded", function () {
    ...
    function performSearch() {
        ...
        if (searchTerm === "") {
            // Show all products and accessories if search is empty
            showAllProducts();
            showAllAccessories();
            return;
        }
        ...
        currentProduct = {
            ...
            description:
                this.closest(".card-body").querySelector("p.text-muted.small")
                    .textContent,
            isAccessory: this.closest(".accessory-item") !== null,
        };
        ...
        .addEventListener("click", () => {
            ...
            const existingItemIndex = cart.findIndex(
                (item) =>
                    ...
                    item.isAccessory === currentProduct.isAccessory
            );
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="cart-item-details flex-grow-1">
                        ...
                        <small class="text-muted">${
                            item.isAccessory ? "Accessory" : "Product"
                        }</small>
                        ${
                            item.discount > 0
                                ? `
