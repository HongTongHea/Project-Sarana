                                ...
                                <form method="POST" action="{{ route('contact.store') }}" class="bg-white p-0"
                                    ...
                                    <div class="mt-4">
                                        <button type="submit" class="btn btn-primary px-2 py-2 w-100 fw-bold btn-sm"
                                            ...
                                            <span class="submit-text">
                                                <i class="fab fa-telegram me-2"></i>Send Message
                                            </span>
                                    ...
                                    <div class="mt-3 text-center">
                                        <small class="text-muted">
                                            ...
                                            You'll be redirected to Telegram with your message ready to send
                                        </small>
                                    </div>
                                </form>
                            </div>
            ...
            if (contactForm) {
                contactForm.addEventListener('submit', function(e) {
                    ...
                    if (this.checkValidity()) {
                        ...
                        submitText.textContent = 'Redirecting to Telegram...';
