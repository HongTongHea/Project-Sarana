  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 mb-4">
        <h5 class="text-uppercase mb-3">AngkorTech Computer</h5>
        <p>Your trusted source for laptops, accessories, and tech gear in Cambodia.</p>
      </div>
    ...
    <div class="text-center">
      <small>&copy; {{ date('Y') }} AngkorTech Computer. All rights reserved.</small>
    </div>
  </div>
</footer>
