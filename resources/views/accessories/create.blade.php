            ...
            <div class="modal-header">
                <div class="d-flex justify-content-center align-items-center">
                    <h6 class="mt-3 ms-1 text-black text-uppercase" style="font-weight: 700; font-size: 16px">
                        <span class="text-dark"> Create Accessory</span>
                    </h6>
                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name"
                                        value="{{ old('name') }}" required placeholder="Enter accessory name">
                                </div>
                                <div class="form-group col-12 col-md-6">
                                ...
                                <div class="form-group col-12 col-md-12">
                                    ...
                                    <textarea name="description" class="form-control" id="description" rows="7">{{ old('description') }}</textarea>
                                </div>
